...
// checks the English catalogue (apps/desktop/src/i18n/en/*.json) has each of
// them. Also reports a German string with two different English translations
// in different catalogue files. Exits non-zero on a problem.
