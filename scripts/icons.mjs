...
// caret, where the full one turns to mush. The macOS icon.icns and the Square*/StoreLogo tiles
// come from the app icon, brand/uwunotes-app-icon.svg, like the website and GitHub.
